...
set val(packetSize) 	2000                          			;# Size of LEACH Packets (KByte)
set val(nsn) 		5                      				;# Number of Sensor Nodes

set val(sn_size) 	3                            			;# Size of Sensor Nodes
set val(bs_size) 	10                            			;# Size of Sensor Nodes
...
for {set i 1} {$i <= $val(nsn)} {incr i} {
	...
	# 1- Variable Binding
	$agent($i) set packetSize_ $val(packetSize)
...
#$ns at 10.0 "puts \"--- OTcl --- PacketSize is:\""
#$ns at 10.1 "puts [$agent(1) set packetSize_]"

#$ns at 10.2 "puts \"--- C++ --- PacketSize is:\""
#$ns at 10.3 "$agent(1) packet-Size"


# 2- running c++ statements from OTcl level by command
#$ns at 10.0 "puts \"--- C++ --- PacketSize is:\""
#$ns at 10.1 "$agent(1) packet-Size"
...
# 4- Passing the Result to OTcl level
$ns at 10.0 "puts \"--- C++ --- PacketSize is:\""
$ns at 10.1 "puts [$agent(1) packet-Size]"
