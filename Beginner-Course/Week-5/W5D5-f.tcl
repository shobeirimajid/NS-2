...
# setting Routing Protocol to Session-Routing 
$ns rtproto Session

# setting Routing Protocol to Distance-Vector Routing
#$ns rtproto DV

# setting Routing Protocol to Static-Routing (Default Routing in NS2 Wired(Internet) Simulations)
#that will be activated if you don't determine routing protocol
...
$ns duplex-link $n8 $n9 0.3Mb 100ms DropTail
$ns duplex-link $n9 $n4 0.5Mb 40ms DropTail
$ns duplex-link $n9 $n5 0.5Mb 40ms DropTail
...
$ns queue-limit $n8 $n9 20
$ns queue-limit $n9 $n8 20
...
# link Orientation
$ns duplex-link-op $n0 $n8 orient right-down
$ns duplex-link-op $n1 $n8 orient right-up
$ns duplex-link-op $n8 $n9 orient right
$ns duplex-link-op $n9 $n4 orient right-up
$ns duplex-link-op $n9 $n5 orient right-down
...
$ns duplex-link-op $n7 $n4 orient right
...
# Queue Monitoring
set qmon [$ns monitor-queue $n8 $n9 $qmFile 0.1];
[$ns link $n8 $n9] start-tracing;
